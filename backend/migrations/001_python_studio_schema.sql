...
-- (Aligned with Alembic revision 002_python_studio_extensions)
...
CREATE INDEX IF NOT EXISTS idx_code_submissions_user ON code_submissions(user_id, submitted_at DESC);
