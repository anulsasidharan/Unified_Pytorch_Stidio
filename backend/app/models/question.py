...
class Question(Base):
    ...
    expected_output_type: Mapped[str] = mapped_column(String(20), default="exact")
    expected_output_shape: Mapped[str | None] = mapped_column(String(200))
    run_in_browser: Mapped[bool] = mapped_column(Boolean, default=True)
    pep8_required: Mapped[bool] = mapped_column(Boolean, default=False)
